...
public class ProductoViewImplInternal extends javax.swing.JPanel {

    private ProductoViewImpl view;

    /** Creates new form JPanelContacto */
    public ProductoViewImplInternal(ProductoViewImpl view) {
        this.view=view;
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jComboEmpresa.setModel(((vista.producto.ProductoViewImpl)view).getComboModel());
...
// TODO add your handling code here:
    try {
        view.fireNuevaProductoGesture(this.jTextFieldIdentificador.getText(), (Empresa)this.jComboEmpresa.getSelectedItem(), this.jTextFieldImporte.getText());
...
// TODO add your handling code here:
    try {
        view.fireActualizaFacturaGesture(this.jTextFieldIdentificador.getText(), (Empresa)this.jComboEmpresa.getSelectedItem(), this.jTextFieldImporte.getText());
    } catch (RuntimeException e) {
        javax.swing.JOptionPane.showMessageDialog(new JInternalFrame(), e, "Warning", JOptionPane.WARNING_MESSAGE);
    }
...
// TODO add your handling code here:
    try {
        view.fireBorraProductoGesture(this.jTextFieldIdentificador.getText());
    } catch (RuntimeException e) {
        javax.swing.JOptionPane.showMessageDialog(new JInternalFrame(), e, "Warning", JOptionPane.WARNING_MESSAGE);
    }
    ...
    public void setProducto(Producto producto) {
        this.jTextFieldIdentificador.setText(producto.getIdentificador());
        this.jComboEmpresa.setSelectedItem(producto.getEmpresa());
        this.jTextFieldImporte.setText(producto.getImporte().toString());
    }
}
